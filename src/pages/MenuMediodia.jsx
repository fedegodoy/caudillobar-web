...
export default function MenuMediodia() {
  const mediodia = menuData.mediodia || [];
    ...
    <div className="min-h-screen bg-brand-light p-6 md:p-12">
      <div className="max-w-3xl mx-auto">
        <header className="mb-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl text-brand-terra text-stroke-comic uppercase font-display tracking-wider">Menú Mediodía</h1>
        </header>

        {mediodia.map((section, idx) => (
          <section key={idx} className="mb-12">
            <h2 className="text-2xl text-brand-brown border-b-4 border-brand-terra pb-2 mb-6 uppercase inline-block max-w-full text-left font-display text-stroke-comic !text-brand-terra">
              {section.section}
            </h2>
