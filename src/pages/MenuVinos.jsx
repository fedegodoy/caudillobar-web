...
export default function MenuVinos() {
  const vinos = menuData.vinos || [];
    ...
    <div className="min-h-screen bg-brand-light p-6 md:p-12">
      <div className="max-w-3xl mx-auto">
        <header className="mb-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl text-brand-terra text-stroke-comic uppercase font-display tracking-wider">Carta de Vinos</h1>
        </header>

        {vinos.map((section, idx) => (
