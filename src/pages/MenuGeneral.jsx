...
export default function MenuGeneral() {
  const general = menuData.general || [];
    ...
    <div className="min-h-screen bg-brand-light p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        <header className="mb-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl text-brand-terra text-stroke-comic uppercase font-display tracking-wider">Menú Caudillo</h1>
        </header>
                  ...
                  <div key={itemIdx} className="flex gap-4 items-start border-b border-brand-brown/20 pb-4">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-start gap-2">
                        ...
                        <div className="font-bold text-brand-terra text-lg bg-brand-terra/10 px-2 py-1 rounded shrink-0 box-shadow-comic border border-brand-terra/20">
